...
const ACTIONS = {
  ...
  "default /app/votes/[year]/[month]": (params: { year: (string | number), month: (string | number) }) => {
    return `/app/votes/${params.year}/${params.month}`
  },
  "register /auth/signin": `/auth/signin?/register`,
  "signout /auth/signout": `/auth/signout?/signout`,
...
export type KIT_ROUTES = {
  PAGES: { '/app': never, '/app/admin': never, '/app/admin/events': never, '/app/admin/users': never, '/app/admin/votes': never, '/app/bookings/[bookingId]': 'bookingId', '/app/checkout/cancel': never, '/app/checkout/success': never, '/app/events': never, '/app/events/[eventId]': 'eventId', '/app/events/[eventId]/photos': 'eventId', '/app/mails': never, '/app/photos': never, '/app/settings/profile': never, '/app/votes': never, '/app/votes/[year]/[month]': 'year' | 'month', '/auth/signin': never, '/auth/signup': never, '/playground': never, '/soon': never }
  SERVERS: { 'GET /auth/oauth/google': never, 'GET /auth/oauth/google/callback': never }
  ACTIONS: { 'deleteUser /app/admin/users': never, 'viewMonth /app/admin/votes': never, 'viewDayInMonth /app/admin/votes': never, 'default /app/events': never, 'default /app/settings/profile': never, 'default /app/votes': never, 'default /app/votes/[year]/[month]': 'year' | 'month', 'register /auth/signin': never, 'signout /auth/signout': never, 'default /auth/signup': never }
