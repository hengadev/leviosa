...
const juridique: Field[] = [
    { name: "Conditions de service", icon: BookOpenText, pathname: getPath("service-condition") }, { name: "Politique de confidentialite", icon: BookOpenText, pathname: getPath("confidential-policy") },
    { name: "Consentement droit a l'image", icon: BookOpenText, pathname: getPath("image-right-consent") },
]
