...
<div class="content" id={eventID} use:swipeBackAction.action>
    ...
    <div class="header container">
        <img
            src={eventInformation.headerImg}
            alt="background location illustration"
        />
        ...
        <div class="container">
            <div class="card grid">
                ...
                <div>
                    ...
                    <p>
                        Met un petit truc avatar + nom + lien vers la fiche
                        prestataire
                    </p>
                </div>
                <div class="card-overlay"></div>
...
<style>
    ...
    .img-container {
        ...
        width: 100%;
        border-radius: max(
            calc(var(--card-border-radius) - var(--card-padding)),
            0.25rem
        );
    }
</style>
