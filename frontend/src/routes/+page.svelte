<script lang="ts">
    ...
    let formControls = $derived(
        pageState === "signin" ? SignInFormControls : SignUpFormControl,
    );
</script>

<div class="container page-container">
    <div class="container content flow" style="--flow-space: 2.5rem;">
        <div class="header grid" style="--gap: 2rem;">
            <div class="flex" style="--gap: 0.5rem; align-items: center;">
                <div class="logo_placeholder">
                    <Slack size={24} />
                </div>
                <p style="font-size: 1.2rem; font-weight: 500; color; black">
                    Leviosa
                </p>
            </div>
            <div class="grid" style="--gap: -0.1rem;">
                ...
                <p>
                    {pageState === "signin"
                        ...
                        : "Cree toi un compte Leviosa"}
                </p>
            </div>
        </div>
        <Tabs {offers} isSecondary={true} />
        <form>
            <div class="grid flow" style="--flow-space: 2rem;">
        ...
        <form class="oauths grid" method="GET">
            <Button
                ...
                leftIcon={Google}
            >
                {pageState === "signin" ? "Se connecter" : "S'enregistrer"} avec
                Google
            </Button>
            <Button
                style="secondary"
