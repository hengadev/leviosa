    ...
    <div class="container grid" style="--gap: 3rem;">
        <div class="grid" style="--gap: 2rem;">
            ...
            <div class="grid" style="--gap: 1rem;">
                <h3 class="title center">Merci de ton inscription</h3>
                <div>
                    <p>
                        Ton inscription est maintenant en attente de validation
                        par un des membres de l'equipe Leviosa Tu recevras un
                        mail et une notification des que ton mail sera
                        disponible
                    </p>
                </div>
            </div>
