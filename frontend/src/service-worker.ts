...
const ASSETS = [...build, ...files].filter(path =>
    !OAUTH_PATHS.some(oauthPath => path.startsWith(oauthPath))
)
...
self.addEventListener("fetch", event => {
    ...
    async function respond() {
        ...
        const pathnameCondition = url.pathname.includes('/oauth/google/callback') || url.pathname.includes('/oauth/apple/callback')
